...
export class Stats {
  ...
  toJSON(stats: ?string | Array<string>) {
    ...
    const collected = (stats ? (typeof stats === 'string' ? stats.split(/[, ]/) : stats) : Object.keys(this._stats)) // if stats is a string, split it by comma else return stats, if stats return stats else return keys of _stats
